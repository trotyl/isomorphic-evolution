import { record, replay } from '../../lib/core.js'
import { elementStart, elementEnd, element, text, textBinding, bootstrap, detectChanges, listener } from '../../lib/runtime.js'

let App_Context
const stateHost = document.querySelector('#app-state')
if (stateHost) {
  App_Context = JSON.parse(stateHost.textContent)
} else {
  App_Context = {
